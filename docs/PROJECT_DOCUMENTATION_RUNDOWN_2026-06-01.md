...
- `README.md` and `docs/ARCHITECTURE.md` have been refreshed for the June 1 audit state, the chat-scroll fix, the June 2 auth rollout, the June 8 Hype/safe-fetch/automation queue updates, and the June 11 Shadow Runner/Shadow Mystery updates.
...
| File | Latest tracked update/status date | Role | Refresh guidance |
| --- | --- | --- | --- |
| [README.md](C:/repos/chat2.0/README.md:1) | 2026-06-11 | Human entrypoint, stack, feature list, commands, deployment, documentation map. | Refresh after security, deployment, or major feature work; keep docs map current. |
...
| File | Latest tracked update/status date | Role | Refresh guidance |
| --- | --- | --- | --- |
| [docs/ARCHITECTURE.md](C:/repos/chat2.0/docs/ARCHITECTURE.md:1) | 2026-06-11 | System map and data-flow overview. | Update after Edge Function hardening, safe-fetch helpers, lib module splits, new backend domains, or major Entertainment/game runtime changes. |
...
| [docs/TESTING_GUIDE.md](C:/repos/chat2.0/docs/TESTING_GUIDE.md:1) | 2026-06-11 | Unit, smoke, and browser testing workflow. | Keep auth, chat-scroll, safe-fetch, Hype, media-frame, composer, and game visual coverage expectations current. |
...
| [docs/SHADOW_RUNNER_ASSET_GENERATION_BACKLOG.md](C:/repos/chat2.0/docs/SHADOW_RUNNER_ASSET_GENERATION_BACKLOG.md:1) | 2026-06-11 | Shadow Runner generated asset backlog and production notes. | Update after each reviewed generation batch or when generated assets move into runtime. |
| [docs/SHADOW_RUNNER_GAMEPLAY_ASSETS.md](C:/repos/chat2.0/docs/SHADOW_RUNNER_GAMEPLAY_ASSETS.md:1) | 2026-06-11 | Shadow Runner HUD, controls, SFX, enemy, route, and gameplay asset wiring. | Update after gameplay HUD/control/audio assets or Phaser runtime asset wiring changes. |
| [docs/SHADOW_RUNNER_HOME_ASSETS.md](C:/repos/chat2.0/docs/SHADOW_RUNNER_HOME_ASSETS.md:1) | 2026-06-11 | Shadow Runner title/menu/campaign-map assets, runtime wiring, rotate-gate constraints, and latest visual verification. | Update after title/menu/campaign-map asset changes, playable-prototype shell changes, or mobile visual QA. |
| [docs/SHADOW_RUNNER_PLAYABLE_PROTOTYPE_ROADMAP.md](C:/repos/chat2.0/docs/SHADOW_RUNNER_PLAYABLE_PROTOTYPE_ROADMAP.md:1) | 2026-06-11 | Active Shadow Runner playable-prototype roadmap and checkpoint notes. | Keep concise; update after playable-route, control, difficulty, or verification milestones. |
...
| File | Latest tracked update/status date | Role | Refresh guidance |
| --- | --- | --- | --- |
| [docs/features/feature-progress-log.md](C:/repos/chat2.0/docs/features/feature-progress-log.md:1) | 2026-06-11 | Feature progress log. | Keep active Shadow Runner checkpoints concise and tied to verification; add a note when audit backlog implementation starts. |
