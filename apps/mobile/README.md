...
7. run foreground, background, and terminated delivery checks against the
   single-account live canary, including ShadowPin image, sender PFP fallback,
...
node scripts/generate-notification-assets.mjs
```
