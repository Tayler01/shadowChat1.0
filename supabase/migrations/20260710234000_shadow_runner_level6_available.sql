/*
  # Shadow Runner Level 6 availability

  Launches Clockmaker Yard as the current hardest available Shadow Runner
  route. The catalog trigger recalculates public runner/knight medals and
  advances the knight requirement to the new production route.
*/
...
VALUES
  ('level-6', 6, 'Clockmaker Yard', 6, false, true, true)
