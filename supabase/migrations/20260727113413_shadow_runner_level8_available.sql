-- Level 8 becomes the hardest available Shadow Runner route. Refreshing the
-- derived medals immediately revokes stale Level 7 knight medals and awards
-- the current medal only to players who have completed Courier Catacombs.
