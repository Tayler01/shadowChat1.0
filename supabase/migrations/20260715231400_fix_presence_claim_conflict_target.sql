-- Keep the presence recipient cooldown claim unambiguous inside a TABLE-returning
-- PL/pgSQL function. The output parameter `recipient_id` otherwise conflicts
-- with the cooldown table column in the ON CONFLICT inference clause.
