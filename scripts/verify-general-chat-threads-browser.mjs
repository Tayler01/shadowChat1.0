...
try {
  for (const profile of profiles) {
    ...
    try {
      ...
      results.push({ profile: profile.name, passed: true, geometry, keyboardGeometry, actionMenuLayer, before, opened, after, restored, consoleErrors, browserDiagnostics, pageErrors })
    } catch (error) {
