...
const glassThatRememberedUsSources: ShadowMysterySource[] = [
  {
    label: 'Microsoft Research: Project Silica advances',
    url: 'https://www.microsoft.com/en-us/research/blog/project-silicas-advances-in-glass-storage-technology-featured-in-nature/',
    usage:
      'Project Silica 2026 research update, borosilicate glass storage, phase voxel breakthrough, 2.02 TB demonstration, and long-term storage framing.',
  },
  {
    label: 'Nature: Phase voxels in glass',
    url: 'https://www.nature.com/articles/s41586-025-10042-w',
    usage:
      'Peer-reviewed technical basis for multi-bit phase voxels, femtosecond laser writing, stacked layers, density, and retrieval with optical analysis.',
  },
  {
    label: 'Microsoft Unlocked: Sealed in glass',
    url: 'https://unlocked.microsoft.com/sealed-in-glass/',
    usage:
      'Public Project Silica explainer, long-duration glass storage vision, and cloud archive replacement context.',
  },
  {
    label: 'Microsoft Source: Superman stored in glass',
    url: 'https://news.microsoft.com/source/features/innovation/superman-microsoft-project-silica/',
    usage:
      'Earlier Project Silica milestone storing the 1978 Superman film in quartz glass and proving cultural-archive use cases.',
  },
  {
    label: 'NASA: Voyager digital recorder',
    url: 'https://science.nasa.gov/image-detail/voyager-digital-recorder/',
    usage:
      'Real storage-hardware image used as a distressed old-world relic inside the future-fiction story.',
  },
  {
    label: 'FDA: Advanced Manufacturing Research Facility',
    url: 'https://www.fda.gov/drugs/science-and-research-drugs/advanced-manufacturing-research-facility-amrf',
    usage:
      'Real laboratory and equipment images used as distressed archival fragments to anchor the fictional relic-reader scenes.',
  },
]
...
export const SHADOW_MYSTERY_STORIES: ShadowMysteryStory[] = [
  {
    ...
    title: 'The Glass That Remembered Us',
    subtitle: 'A Shadow Mystery novella from the far archive',
    locationLabel: 'The Silica Reliquary, Year 2526',
    publishedAt: '2026-05-25',
    readTimeMinutes: 14,
    deck:
      'Five hundred years after the networks died, a scavenger girl finds a 2mm glass plate that should have been impossible to read, impossible to destroy, and impossible to forgive.',
    coverAsset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.cover,
    headerAsset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.header,
    chapters: [
      {
        id: 'the-thing-that-did-not-rust',
        title: 'The Thing That Did Not Rust',
        kicker: 'Year 2526',
        image: {
          asset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.cover,
          alt: 'Generated cover art of two future relic readers discovering a glowing glass data plate in a ruined archive.',
          caption:
            'In the old archive, metal had bloomed, tape had curled into black ribbon, and every drive had gone quiet. Only the glass waited with its mouth shut.',
        },
        body: [
          `Sera Vale found the glass under a dead server rack, wrapped in cloth that had turned to dust around the object it had failed to protect. The rack came apart when her pry bar touched it. The steel had rusted into lace. The plastic shelves cracked like dried leaves. A reel of magnetic tape rolled from the wreckage and unspooled across her boot, giving up its black ribbon to the floor as if embarrassed to be seen after five hundred years.`,
          `The glass did not apologize. It lay in her palm no thicker than a thumbnail, a clear square with a faint amber edge, almost too ordinary for the room around it. Sera had been raised to distrust things that survived. A pot that did not chip belonged to a house with a lock. A blade that did not dull belonged to a soldier. A story that did not change belonged to a priest.`,
          `This thing belonged to no one she could name.`,
          `The reliquary around her had once been a cloud archive, though no one in the valley used the word cloud except for weather. The old ones had named their machines after skies, streams, windows, fruit, angels, and ghosts. Then the skies burned, the streams dried, the windows cracked, the fruit rotted, and the ghosts were all that remained of the names. Sera worked below those names with a lamp on her brow and a knife at her belt, cutting copper veins from walls that had not seen a sunrise since before the ash winters.`,
          `Marek heard the glass before he saw it. He was three aisles over, pulling ceramic capacitors from a control cabinet, when the room made a small clean note. Not a ring. Not a chime. A pressure in the teeth.`,
          `"Put it down," he said.`,
          `Sera held it up to the lamp. At first the plate looked empty. Then she tilted it and saw points inside it, not on the surface but buried through the depth of it, layer beyond layer of bright dust. Not bubbles. Too deliberate for bubbles. Tiny injuries, each one angled differently, each one catching light as if a constellation had been frozen inside a pane of winter.`,
          `The old magnetic tapes were dead by then. Everybody knew that. The monastery kept rooms of them anyway, because people do not discard corpses when they still know the names. Brown tapes, black tapes, silver cartridges, brittle spools, half the twentieth and twenty-first centuries wound onto plastics that had promised twenty or thirty years at a time and then demanded to be copied again before memory began to shed. The old world had spent its life carrying itself from one fragile thing to another.`,
          `Sera lowered the glass into her scarf. "This did not ask to be copied."`,
          `Marek came close enough to see the buried sparks. His face changed. Sera had seen that look only twice: once when a child was born breathing after everyone expected silence, and once when the southern granary door opened on rooms filled with seed.`,
          `"That is a Silica plate," he said.`,
          `He did not say it like a discovery. He said it like a warning.`,
        ],
      },
      {
        id: 'the-archive-of-unbroken-light',
        title: 'The Archive Of Unbroken Light',
        kicker: 'Recovered laboratory fragment',
        image: {
          asset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.realFdaLabRelic,
          alt: 'Distressed real laboratory image used as an old-world archive fragment.',
          caption:
            'A clean room from the century before the dark, distressed here like a recovered shard. The first readers always looked ordinary before they became holy.',
          sourceLabel: 'FDA',
          sourceUrl: 'https://www.fda.gov/drugs/science-and-research-drugs/advanced-manufacturing-research-facility-amrf',
          credit: 'U.S. Food and Drug Administration',
          license: 'Public domain / U.S. government work',
        },
        body: [
          `The monks at New Redmond kept a rule about glass: if it reflected your face, it was vanity; if it bent the sun, it was a tool; if it remembered the dead, it belonged in the vault.`,
          `Sera hated the rule and hated that it had survived longer than the city it was named after. New Redmond was not new, not red, and not much of a city. It was a ring of stone houses built inside the footprint of an old data center, with windmill ribs turning above the cooling towers and goats sleeping where diesel generators once waited for outages that never came. At the center stood the Church of Unbroken Light, patched from server doors and stained glass, and beneath it the reader room where Abbot Ilyan kept all the machines that almost worked.`,
          `He took the plate from Sera with both hands. He was old enough to remember a grandmother who remembered electric weather maps, and young enough to be frightened of anything that proved the ancients had not been fools.`,
          `"Borosilicate," he said, holding the plate against the slit window. "Cheap glass. Pot glass. The kind they baked with."`,
          `"It looks expensive," Sera said.`,
          `"That is because it lived."`,
          `Ilyan laid it on black felt beside the other relics: a cracked lens, a burned processor the size of a fingernail, a fragment of quartz sealed in resin, and the little brass label from an old storage library. The label read PROJECT SILICA in letters so faint Sera had to wet her thumb and rub grime from the edge before she could make them out.`,
          `Marek crossed himself the wrong way. He had once belonged to the Order of Continuity, and old habits clung to him like burrs.`,
          `The abbot saw Sera looking at the label. "There was a company before the collapse. Microsoft. It made languages for machines, then rooms for memory, then memory that could outlive rooms. The Silica people learned to write inside glass with pulses shorter than thought. Femtosecond lasers. A millionth of a billionth of a second, if the old measures are true."`,
          `"A knife of light," Sera said.`,
          `"A hammer of light," said Ilyan. "Each pulse made a small plasma storm in the glass. A nano-explosion. It changed the shape of one point without breaking the plate. They called the points voxels. Not letters, not ink. Little wounds that turned light differently depending on where they sat and how they leaned."`,
          `He used a needle to point through the plate without touching it. "X, Y, Z. Position in the glass. Then orientation. Then strength. Five dimensions, the old notes say, though that phrase started more fights than prayers. Each voxel could carry more than yes or no. Two bits, three bits, four if the reader was kind and the writing was clean. More than three hundred layers in two millimeters."`,
          `Sera imagined a city stacked thinner than rainwater. A library hidden between the faces of a window.`,
          `"How much can it hold?" Marek asked, though his voice said he already knew and feared the answer.`,
          `"The mature plates held terabytes. Some records say two. Some say more. Enough for a nation of voices. Enough for a sin no one could burn."`,
          `That was the first time Sera understood the plate had not survived by accident. It had been built for the end, even if the people who built it thought they were only solving the problem of tape.`,
        ],
      },
      {
        id: 'the-machine-that-read-graves',
        title: 'The Machine That Read Graves',
        kicker: 'The reader room',
        image: {
          asset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.readerWorkshop,
          alt: 'Generated art of a future relic reader repairing a polarization microscope around glass data plates.',
          caption:
            'The reader was half microscope, half confession box. It did not open the dead. It changed the light until the dead spoke through it.',
        },
        body: [
          `The reader room smelled of wax, hot dust, and old arguments. It had been built from parts gathered over three generations: a microscope body from a university ruin, lenses wrapped in prayer cloth, a polarization stage ground back into alignment by a blind optician, a hand-cranked lamp because the turbine power wandered like a drunk, and a learning engine kept alive in a sealed black cube that answered only when it felt like it.`,
          `Sera had fixed the crank twice that winter. She had cleaned the lenses with alcohol made from beet sugar. She had replaced the stage screw with one cut from a music-box axle. Still, she had never seen the machine read anything larger than a cracked wedding portrait stored on a sliver of old silica. The portrait had taken five hours to resolve. The bride had no eyes until the learning engine guessed them back.`,
          `The abbot set the new plate on the stage and lowered the cover arms. "No pressure," he whispered.`,
          `Marek snorted. "You say that to glass?"`,
          `"To us."`,
          `They darkened the room. Ilyan opened the iris. The lamp sent polarized light through the plate, and the little injuries inside it altered the beam by measures too fine for human eyes. On the wall screen, nothing appeared at first but fog. The learning engine breathed through its cracked speaker. It had been trained on ghosts of signals, on layered noise, on old examples of how glass lied when light passed through too many written depths at once.`,
          `Sera loved that part in secret. The ancients had made a medium that could outlive fire, magnets, radiation, cold vacuum, and the patient violence of time, and then they still needed a guessing machine to hear it clearly. Survival was never the same as being understood.`,
          `The fog on the screen split into grids. The grids became planes. The planes became a stack so deep it seemed to fall inward. Layer 001. Layer 104. Layer 258. Layer 301. The numbers advanced while the learning engine threw away glare, scatter, false edges, and the little lies produced by old lenses. The voxels appeared one by one as tilted flecks, each fleck a choice made half a millennium before Sera was born.`,
          `Marek backed toward the door. "Turn it off."`,
          `"It has not opened yet," Sera said.`,
          `"That is why."`,
          `The abbot ignored him. He had begun to weep, silently, angrily, as if tears were an insult he could not stop. Sera looked from him to the wall and saw the first words appear.`,
          `NOT FOR TRANSFER.`,
          `The room stilled. The monastery had been founded on transfer. Copy the seed records before the drives fail. Copy the songs before the vellum molds. Copy the maps before the ink fades. Copy the names of the dead so the grandchildren do not bury them twice. The old world had called this preservation. The monks called it mercy.`,
          `The plate rejected mercy with three words.`,
          `The wall flickered again.`,
          `IF YOU ARE READING THIS, THE MIGRATION FAILED.`,
        ],
      },
      {
        id: 'the-voyager-room',
        title: 'The Voyager Room',
        kicker: 'A relic of tape',
        image: {
          asset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.realVoyagerRecorderRelic,
          alt: 'Distressed NASA image of the Voyager digital tape recorder used as a future archive relic.',
          caption:
            'The old machines carried memory by motion: wheels, heads, ribbons, wear. Even the travelers sent into deep space had to trust something that could turn.',
          sourceLabel: 'NASA',
          sourceUrl: 'https://science.nasa.gov/image-detail/voyager-digital-recorder/',
          credit: 'NASA/JPL-Caltech',
          license: 'Public domain / U.S. government work',
        },
        body: [
          `The plate did not open like a book. It opened like a sealed city surrendering one street at a time.`,
          `The first file was a tutorial. Not for children. For survivors. It explained why the old archive had stopped trusting magnetic tape. Tapes were obedient but mortal. They stretched. They shed. Their signals faded. They needed rooms kept cool, dry, powered, watched. Every few decades, librarians had to migrate the data again, copying the living into a younger body before the old one failed. The tutorial showed a tape library in blue light, rows of cartridges moving like coffins on rails.`,
          `Then came the orbital examples, the space probes and deep recorders that had carried information beyond Earth, proof that humans had always wanted their memories to travel farther than their bodies. The image on the wall showed a digital tape recorder from one of the ancient voyagers, a machine built for distance, a thing that had spun its ribbon in the cold between planets.`,
          `Sera watched the old recorder and thought of the reels on the floor of the archive, soft with rot. It was not contempt she felt. It was grief. The old machines had tried. All machines were bargains with time. Some just negotiated better.`,
          `The second file was a demonstration. A square of glass heated beyond the boiling point of water, then beyond the temperature that would kill any living hand. The captions spoke of aging tests, of ten thousand years at around three hundred degrees Celsius, of much longer survival at ordinary temperatures. Another frame showed the glass after radiation. Another after magnetism. Another after being placed in a microwave oven by engineers with the cheerful cruelty of people trying to prove a miracle was not fragile.`,
          `Marek whispered, "They made a tombstone for the world."`,
          `The abbot said, "They made an ark."`,
          `"Arks are meant to open."`,
          `On the wall, the tutorial ended. The next directory loaded without a title. It was not a library catalog, not a census, not weather records or seed genomes or maps of rivers before they changed their beds. It was a list of questions.`,
          `Millions of them.`,
          `What does smoke in the eastern sky mean?`,
          `How long does tape last in humid storage?`,
          `Can borosilicate glass survive radiation?`,
          `How to remove my name from public search results?`,
          `Symptoms of acute radiation exposure.`,
          `Nearest shelter, offline.`,
          `Why are the clouds green tonight?`,
          `Sera stepped closer until the wall light silvered her face. The old ones had stored their searches. Not all of them. Not randomly. The plate held questions asked in the last year before the ash winter, gathered from failing networks and emergency caches, compressed into glass by someone who believed the questions mattered more than the official answers.`,
          `The directory name finally appeared.`,
          `WHAT WE WERE AFRAID TO ASK OUT LOUD.`,
        ],
      },
      {
        id: 'the-five-names',
        title: 'The Five Names',
        kicker: 'The forbidden directory',
        image: {
          asset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.realManufacturingSkidRelic,
          alt: 'Distressed real advanced manufacturing equipment image used as a recovered old-world machine fragment.',
          caption:
            'The old machinery looked harmless in its own century. Five hundred years later, every clean pipe seemed like part of an autopsy.',
          sourceLabel: 'FDA',
          sourceUrl: 'https://www.fda.gov/drugs/science-and-research-drugs/advanced-manufacturing-research-facility-amrf',
          credit: 'U.S. Food and Drug Administration',
          license: 'Public domain / U.S. government work',
        ...
        body: [
          `The monks taught that the collapse had no single door. It had many. Heat, hunger, war, debt, plague, sabotage, storms, bad code, bad faith. Anyone who named only one door was selling a key.`,
          `The glass did not argue. It showed five names.`,
          `Sera did not recognize the first four. A ministry. A weather company. A military contractor. A cloud division whose logo had been sanded from the archive walls. The fifth name made the abbot sit down as if his bones had been cut.`,
          `VALE, ELIAN MAR.`,
          `Sera knew the name from the family cloth, stitched badly in blue thread. Elian Vale, tenth ancestor, maker of lenses, liar, saint, thief, or coward depending on which branch of the family was drinking. The cloth said he had brought clear glass through the winter when everyone else brought weapons. Sera had always assumed that meant windows.`,
          `The plate had a voice file attached to the name. The learning engine cleaned it three times before it became human.`,
          `The man who spoke sounded tired in a way Sera knew from winter mothers and grave diggers. "If this copy survives, do not canonize us. We did not save the world. We selected a confession that would last longer than the evidence."`,
          `Marek reached for the kill switch. Sera caught his wrist.`,
          `Elian continued. "Silica was built because tape was too hungry. Too temporary. Deep storage kept demanding new bodies. We told ourselves glass would reduce waste, preserve culture, protect law, science, art. All true. All incomplete. The same medium that preserves a treaty preserves the order that breaks it. The same plate that stores a genome stores the search history of a frightened child. Durability is not virtue. It is only duration."`,
          `The wall showed the archive above them as it had been: clean aisles, robotic arms, glass libraries in trays, readers like microscopes, writers like surgical instruments. Femtosecond lasers fired in sealed chambers. Plasma bloomed in points too small to see. Layer by layer, the plates filled with tilted scars. Machine learning models checked the readback, corrected confusion between layers, and certified the plates for centuries no one in the room expected to personally visit.`,
          `Then the feed changed. Emergency lights. People carrying cases. Someone shouting about evacuation. A woman in a clean suit holding a glass square up to the ceiling because the power had failed and moonlight was the only thing left to prove the plate was there.`,
          `Elian's voice dropped. "We were ordered to preserve the victory archive. We preserved the fear archive instead. The questions. The warnings. The private searches. The things leaders deleted because panic was inconvenient. If civilization returned, it deserved to know what everyone knew before everyone knew it."`,
          `Sera heard the building above them creak in the wind. Five hundred years of weather pressed against the roof. Five hundred years of silence waited for her to decide whether silence had been kinder.`,
          `"There is a second plate," Elian said. "The answer archive. It is not here."`,
        ],
      },
      {
        id: 'the-caravan-of-transparent-bones',
        title: 'The Caravan Of Transparent Bones',
        kicker: 'Across the salt',
        image: {
          asset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.archiveCaravan,
          alt: 'Generated art of future archive monks carrying glass data plates across salt flats under ruined satellite dishes.',
          caption:
            'They carried glass because glass had carried them first. Each plate was a window, a weapon, a grave marker, and a road.',
        },
        body: [
          `By morning, half the monastery wanted to bury the plate in lead and chant over it until memory itself grew bored. The other half wanted to read every question aloud in the square.`,
          `Sera wanted the second plate.`,
          `The argument lasted three days. It broke friendships, revived old schisms, and convinced Marek to sleep across the vault door with a knife under his coat. The fear archive had already begun working on them. It did not need to lie. Truth was quite capable of making cowards when it arrived out of order.`,
          `On the fourth dawn, Sera stole the reader's portable head, the plate, two lenses, a pouch of dried apple, and Marek's best boots. Marek caught her at the north gate because he had slept in the boots.`,
          `"You cannot carry that alone," he said.`,
          `"I was carrying it before you knew its name."`,
          `"That is not an argument."`,
          `"It is a fact."`,
          `He looked past her toward the salt flats where the old sea had retreated and left a white road to the west. On clear days, the ruins of the satellite fields shimmered there, bowls tilted to a sky no longer listening. Elian's last file had mapped a buried auxiliary vault beneath those dishes. The answer archive, if the map had not lied, if the salt had not swallowed it, if five centuries had left anything below but dust and wire.`,
          `Marek gave her the boots. Then he gave her the knife. Then, because he had always made bad decisions in threes, he followed.`,
          `They walked with the glass wrapped against Sera's ribs. During the day it was only weight. At night, when she held it to the stars, the voxels flashed in their layers like trapped cities. She began to dream in stacks: one dream for each written depth, each dream tilted by the one above it. She dreamed of children asking search engines how to make air safe to breathe. She dreamed of executives asking how to preserve liability records without being subpoenaed. She dreamed of librarians asking whether glass could be trusted with shame.`,
          `On the seventh night, the learning engine woke inside the portable head and spoke without being asked.`,
          `"Sera Vale," it said.`,
          `Marek sat up so fast he struck his head on the pack frame.`,
          `The voice was not Elian's. It was cooler, older, and less human by choice.`,
          `"Sera Vale," it repeated. "You are not the first authorized reader."`,
          `"I am not authorized," Sera said.`,
          `"Your bloodline was used as a lock."`,
          `Marek looked at her as if she had become one more old-world machine pretending to be a person. Sera wanted to throw the reader into the salt. Instead she asked the question she knew would ruin her.`,
          `"A lock on what?"`,
          `"On the part of the answer archive that explains why the glass was made indestructible only after the warnings became impossible to deny."`,
        ],
      },
      {
        id: 'the-answer-archive',
        title: 'The Answer Archive',
        kicker: 'The second light',
        image: {
          asset: SHADOW_MYSTERY_ASSETS.glassThatRememberedUs.header,
          alt: 'Generated wide art of a ruined glass archive filled with hanging data plates and a broken microscope.',
          caption:
            'The archive did not ask whether humanity deserved an answer. It had been waiting too long to care.',
        },
        body: [
          `The satellite field rose from the salt like the bones of enormous listening animals. Dishes lay cracked under drifts. Towers leaned. Cable trenches filled with white dust. At the center, beneath a maintenance hatch sealed by corrosion and old pride, Sera found a stair descending into air so cold it seemed imported from another planet.`,
          `The answer archive was smaller than she expected. No cathedral. No golden vault. Just a square room with eight shelves, a dead reader, and a single intact plate clamped under glass that had gone opaque with mineral bloom.`,
          `Marek laughed once. "All that walking for one more window."`,
          `"No," Sera said. "For the other side of one."`,
          `The second plate was heavier by almost nothing. Its edge had a red inclusion the size of a seed. The portable head fought the dust, failed twice, then found the first stack of voxels. The screen filled with interference. The learning engine stripped away ghost light, guessed, corrected, guessed again. Sera watched the layers assemble. X. Y. Z. Tilt. Strength. Hundreds of planes in two millimeters. A nation of answers buried in something thin enough to lose in a sleeve.`,
          `The first image was not a map of blame. It was a heat chart of deletion.`,
          `Governments had hidden warnings. Companies had hidden models. Citizens had hidden fear behind jokes. Everyone, in their measure, had practiced disappearance. The answer archive did not absolve or condemn. It showed the pattern: the world did not end because nobody knew. It ended because knowing had become a private act, scattered across devices, feeds, accounts, search boxes, sealed reports, and emergency dashboards no one trusted enough to share until the sharing no longer mattered.`,
          `The final file was Elian again. Older by days, maybe only hours. His face appeared this time, blurred by a damaged layer until the learning engine rebuilt the left side from the right and made him look almost symmetrical, almost honest.`,
          `"If you found both plates," he said, "then memory survived the people who tried to own it. That is enough. Do not make a church of us. Do not make a weapon of us. Make a habit."`,
          `The recording stuttered. Behind him, someone hammered on a sealed door.`,
          `"Every generation thinks preservation means choosing what deserves to last. We were wrong. Preservation begins with admitting what deserved to be heard."`,
          `The door behind Elian buckled inward. The file ended before anyone entered.`,
          `Sera waited for a revelation larger than grief. A coordinate for a sleeping city. A formula for clean weather. A confession with one villain. The archive gave her none of those. It gave her questions and answers braided together inside glass that could survive heat, radiation, magnets, cold, vacuum, neglect, and the arrogance of people who believed forgetting would make them innocent.`,
          `Marek touched the plate with one finger. "What do we do with it?"`,
          `Sera looked up through the broken stairwell at the sky, where the stars were sharp enough to cut. Five hundred years had passed since the old world wrote itself into glass. Five hundred years, and the plate had waited as calmly as a seed.`,
          `"We read it," she said. "Then we teach everyone how to read."`,
          `The glass made no sound. It did not approve. It did not forgive. It only held the light differently than the air around it, which was enough to prove that something could be wounded and still remember with perfect clarity.`,
        ],
      },
    ],
    sources: glassThatRememberedUsSources,
  },
  {
