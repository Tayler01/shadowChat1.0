...
describe('ShadowWarBattleCinematic', () => {
  it('renders a state-driven round clash summary', () => {
    ...
    expect(screen.getByRole('button', { name: 'Champion strength 8', hidden: true })).toBeInTheDocument()
    expect(screen.getByRole('button', { name: 'Sovereign strength 10', hidden: true })).toBeInTheDocument()
