...
test('SECURITY DEFINER allowlist is explicit, categorized, and duplicate-free', () => {
  ...
  for (const signature of [
      'create_my_native_notification_enrollment_ticket_v2(text,uuid,text,text)',
      'redeem_native_notification_enrollment_ticket_v2(text,text,uuid,text,text,text,text,text,text,text,integer,text)',
      'register_my_native_notification_token_v2(uuid,text,text,text)',
    ...
    assert.ok(contract.internal_signatures.includes(signature))
  }
